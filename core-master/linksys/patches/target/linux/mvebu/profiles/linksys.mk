...
define Profile/Venom
  NAME:=Linksys WRT32X (Venom)
  PACKAGES:= kmod-mwlwifi wpad-mini swconfig
endef

define Profile/Venom/Description
 Package set compatible with the Linksys WRT32X (Venom).
endef

$(eval $(call Profile,Venom))
